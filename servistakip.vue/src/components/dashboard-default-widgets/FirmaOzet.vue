                ...
                <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                    ...
                    <div class="row mb-1">
                        <div class="col-md-4 fv-row">
                            ...
                            <Field type="text" class="form-control form-control-solid form-control-sm" placeholder="" name="cihazno" />
                        ...
                        <div class="col-md-4 fv-row">
                            <label class="required fs-5 fw-semobold mb-2">Cari Kod</label>
                            <Field type="text" class="form-control form-control-solid form-control-sm" placeholder="" name="carikod" />
                            <div class="fv-plugins-message-container">
                                <div class="fv-help-block">
                        ...
                        <div class="col-md-4 fv-row">
                            <label class="required fs-5 fw-semobold mb-2">Sektör</label>
                            <Field type="text" class="form-control form-control-solid form-control-sm" placeholder="" name="sektor" />
                            <div class="fv-plugins-message-container">
                                <div class="fv-help-block">
                    ...
                    <div class="d-flex flex-column mb-5 fv-row">
                        ...
                        <!--begin::Select-->
                        <Field name="country" class="form-select form-select-solid" as="select">
                    ...
                    <div class="d-flex flex-column mb-5 fv-row">
                        ...
                        <!--begin::Input-->
                        <Field class="form-control form-control-solid" placeholder="" name="address1" />
                        <div class="fv-plugins-message-container">
                            <div class="fv-help-block">
                    ...
                    <div class="d-flex flex-column mb-5 fv-row">
                        ...
                        <!--begin::Input-->
                        <Field class="form-control form-control-solid" placeholder="" name="address2" />
                        <div class="fv-plugins-message-container">
                            <div class="fv-help-block">
                    ...
                    <div class="d-flex flex-column mb-5 fv-row">
                        ...
                        <!--begin::Input-->
                        <Field class="form-control form-control-solid" placeholder="" name="town" />
                        <div class="fv-plugins-message-container">
                            <div class="fv-help-block">
                    ...
                    <div class="row g-9 mb-5">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <!--begin::Input-->
                            <Field class="form-control form-control-solid" placeholder="" name="state" />
                            <div class="fv-plugins-message-container">
                                <div class="fv-help-block">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <!--begin::Input-->
                            <Field class="form-control form-control-solid" placeholder="" name="postCode" />
                            <div class="fv-plugins-message-container">
                                <div class="fv-help-block">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <label class="form-check form-switch form-check-custom form-check-solid">
                                <!--begin::Input-->
                                <Field class="form-check-input" name="billing" type="checkbox" value="1" checked="checked" />
                                <div class="fv-plugins-message-container">
                                    <div class="fv-help-block">
