                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true"
                                ...
                                <div class="row mb-1">
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <el-select @change="onDeviceNoChange()" filterable remote clearable
                                            placeholder="Cihaz no giriniz" reserve-keyword remote-show-suffix
                                            v-model="selectedDevice" :remote-method="remoteMethodCihazNo"
                                            :loading="loading">
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <el-input readonly disabled v-model="firmaOzet.accountCode"
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <el-input readonly disabled v-model="firmaOzet.customerSector"
                                ...
                                <div class="row mb-1">
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <el-select @change="onCustomerChange()" filterable remote clearable
                                            placeholder="Arama için en az 4 harf giriniz" reserve-keyword
                                            remote-show-suffix v-model="selectedCustomer" :remote-method="remoteMethod"
                                            :loading="loading">
                                            <li class="el-select-dropdown__item">
                                                <div class="row">
                                                    <div class="col-md-6">
                                ...
                                <div class="row mb-1">
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <el-input readonly disabled v-model="firmaOzet.cityName"
                                            class="input-with-select"> </el-input>
                                        <div class="fv-plugins-message-container">
                                            <div class="fv-help-block">
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <el-input readonly disabled v-model="firmaOzet.districtName"
                                            class="input-with-select"> </el-input>
                                        <div class="fv-plugins-message-container">
                                            <div class="fv-help-block">
                                                <ErrorMessage name="departman" />
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <el-input readonly disabled v-model="firmaOzet.quarterName"
                                            class="input-with-select"> </el-input>
                                        <div class="fv-plugins-message-container">
                                            <div class="fv-help-block">
                                                <ErrorMessage name="departman" />
                                ...
                                <div class="row mb-1">
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <el-input readonly disabled v-model="firmaOzet.authorizedName"
                                            class="input-with-select">
                                        </el-input>
                                        <div class="fv-plugins-message-container">
                                            <div class="fv-help-block">
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <el-input readonly disabled v-model="firmaOzet.authorizedTask"
                                            class="input-with-select">
                                        </el-input>
                                        <div class="fv-plugins-message-container">
                                            <div class="fv-help-block">
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <el-input readonly disabled v-model="firmaOzet.authorizedEmail"
                                            class="input-with-select">
                                        </el-input>
                                        <div class="fv-plugins-message-container">
                                            <div class="fv-help-block">
                                ...
                                <div class="row mb-1">
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <el-input readonly disabled v-model="firmaOzet.authorizedPhone"
                                            class="input-with-select">
                                        </el-input>
                                        <div class="fv-plugins-message-container">
                                            <div class="fv-help-block">
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <el-input readonly disabled v-model="firmaOzet.regionCode"
                                            class="input-with-select"> </el-input>
                                        <div class="fv-plugins-message-container">
                                            <div class="fv-help-block">
                        ...
                        <template #header>
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-9">
                                        <span
                                            style="color: #f56c6c; font-size: 13pt; font-weight: 700">Sözleşmeler</span>
                                    </div>
                ...
                <div class="col-md-5 col-lg-5 col-xl-5 col-xxl-5">
                    <el-card class="box-card">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <el-select @change="onModelNameChange()" filterable remote clearable
                                    placeholder="Model adı giriniz" reserve-keyword remote-show-suffix
                                    v-model="selectedModelName" :remote-method="remoteMethodModelName" :loading="loading">
                                    <li class="el-select-dropdown__item">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <span style="font-weight: 900"> Unvan </span>
                                    ...
                                    <el-option v-for="item in modelList" :key="item.rowId" :label="item.model"
                                        :value="item.rowId">
                                        <div class="row">
                                            <div class="col-md-6" style="font-size: 12px">
                                                {{ item.title }}
                            ...
                            <div class="col-md-6 mt-2">
                                <el-select @change="onSerialNoChange()" filterable remote clearable
                                    placeholder="Seri no giriniz" reserve-keyword remote-show-suffix
                                    v-model="selectedSerialNo" :remote-method="remoteMethodSerialNo" :loading="loading">
                                    <li class="el-select-dropdown__item">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <span style="font-weight: 900"> Unvan </span>
                                    ...
                                    <el-option v-for="item in seriNoList" :key="item.rowId" :label="item.serialNo"
                                        :value="item.rowId">
                                        <div class="row">
                                            <div class="col-md-6" style="font-size: 12px">
                                                {{ item.title }}
                            ...
                            <div class="col-md-6 mt-2">
                                <el-input disabled v-model="device.assemblyDateString" style="font-size: 12px">
                                </el-input>
                            </div>
                        </div>
                    </el-card>
                ...
                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                    <el-card class="box-card">
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-2">
                                <el-input v-model="firmaOzet.deviceStatus"></el-input>
                            </div>
                            <div class="col-md-6 mt-2">
            ...
            <el-card class="box-card">
                <template #header>
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-9">
                                <span style="color: #f56c6c; font-size: 14pt; font-weight: 700">Açılan Servis
                                    Kayıtları</span>
                            </div>
                            <div class="col-md-3" style="text-align: right">
                                <el-dropdown split-button type="success">
        ...
        async getMainPageCustomer(rowId) {
            await this.store
                ...
                .then(result => {
                    ...
                    this.backgroundColor =result.data.deviceDto.status ? "green" : "red";
                })
                .catch(() => {
