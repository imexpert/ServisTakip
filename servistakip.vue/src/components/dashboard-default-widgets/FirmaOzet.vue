<template>
            ...
            <div class="d-flex align-items-center me-5">
                <el-button-group class="ml-4">
                    <el-button type="primary" @click="addCustomer()">
                        ...
                        <span style="vertical-align: middle"> Yeni Müşteri Ekle </span>
                    </el-button>
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true"
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <Field type="text" disabled class="form-control form-control-solid form-control-sm"
                                    placeholder="" name="carikod" />
                                <div class="fv-plugins-message-container">
                                    <div class="fv-help-block">
    ...
    <div class="modal" tabindex="-1" id="kt_modal_new_customer" ref="kt_modal_new_customerRef">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <el-form id="kt_modal_new_target_form" @submit.prevent="submit()" :model="customerData"
                        ref="formRef" status-icon :rules="rules" class="form">
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                    title="Müşteri unvan bilgisini giriniz"></i>
                            </label>
                            <!--end::Label-->

                            <el-form-item prop="title">
                                <el-input v-model="customerData.title" placeholder="Müşteri Unvanını giriniz"
                                    name="title"></el-input>
                            </el-form-item>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                    title="Müşterinin faaliyet gösterdiği sektörü seçiniz"></i>
                            </label>
                            <!--end::Label-->

                            <el-form-item prop="sectorId">
                                <el-select placeholder="Müşteri sektörü seçiniz" filterable
                                    v-model="customerData.sectorId">
                                    <el-option v-for="item in sectorList" style="height: 30px" :value="item.id"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <el-form-item prop="cityId">
                                        <el-select placeholder="Şehir seçiniz" @change="onCityChange()" filterable
                                            v-model="customerData.cityId">
                                            <el-option v-for="item in cityList" style="height: 30px" :value="item.id"
                                                :key="item.id" :label="item.name" />
                                        </el-select>
                                    </el-form-item>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <el-form-item prop="districtId">
                                        <el-select placeholder="İlçe seçiniz" @change="onDistrictChange()" filterable
                                            v-model="customerData.districtId">
                                            <el-option v-for="item in districtList" style="height: 30px"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <el-form-item prop="querterId">
                                        <el-select placeholder="Semt seçiniz" filterable
                                            v-model="customerData.querterId">
                                            <el-option v-for="item in querterList" style="height: 30px" :value="item.id"
                                                :key="item.id" :label="item.name" />
                                        </el-select>
                                    </el-form-item>
                                </div>
                        ...
                        <div class="text-center">
                            <button type="reset" id="kt_modal_new_target_cancel"
                                class="btn btn-white me-3">Vazgeç</button>
    ...
    <el-dialog :before-close="handleClose" v-model="centerDialogVisible" title="Müşteri Ekleme / Güncelleme" width="30%"
        destroy-on-close center>
        <el-form id="kt_modal_new_target_form" @submit.prevent="submit()" :model="customerData" ref="formRef"
            status-icon :rules="rules" class="form">
            <!--begin::Input group-->
            <div class="d-flex flex-column mb-8 fv-row">
                <!--begin::Label-->
                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
            ...
            <div class="d-flex flex-column mb-8 fv-row">
                ...
                <el-form-item prop="sectorId">
                    <el-select placeholder="Müşteri sektörü seçiniz" filterable clearable
                        v-model="customerData.sectorId">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <el-form-item prop="querterId">
                            <el-select placeholder="Semt seçiniz" filterable clearable :options="querterList"
                                v-model="customerData.querterId">
                                <el-option v-for="item in querterList" :key="item.id" :label="item.name"
                                    :value="item.id" />
                            </el-select>
                        </el-form-item>
                    </div>
