        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-md-5">
                <el-card class="box-card">
                    ...
                    <div class="text item">
                        <el-table :data="contracts" style="width: 100%" max-height="147" :default-sort="{ prop: 'startDate', order: 'descending' }">
            ...
            <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                <el-card class="box-card">
                    <div class="row">
                        <div class="col-md-6">
                            <label class="fs-5 fw-semobold mb-2">Model</label>
                        </div>
                        <div class="col-md-6">
                            <el-input disabled>
                            </el-input>
                        ...
                        <div class="col-md-6 mt-2">
                            <label class="fs-5 fw-semobold mb-2">Seri No</label>
                        </div>
                        <div class="col-md-6 mt-2">
                            <el-input disabled>
                            </el-input>
