          ...
          <div class="card-header">
            <div class="row">
              <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12">
                <span class="mx-1" style="color: red; font-size: large"> MÜŞTERİ RAPORU </span>
              </div>
            </div>
          </div>
        </template>
          ...
          >
            <div class="row mb-3">
              <div class="col-md-12 col-lg-12 col-xl-4 col-xxl-4 col-sm-12 mb-2">
                <label class="fs-5 fw-semobold mb-2">Rapor Türü</label>
                <el-select class="arama" v-model="filter.raporTuru" placeholder="Rapor Tipi">
                  <el-option label="Aktif Müşteri" :value="1" />
                  <el-option label="Pasif Müşteri" :value="2" />
                </el-select>
              </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12">
              ...
              >
                ...
                <el-table-column label="Seri No" width="140" sortable>
                  <template #default="scope">
                    <div style="display: flex; align-items: center">
                      <span>{{ scope.row.cihazSeriNo }}</span>
                    </div>
                  </template>
                </el-table-column>
                <el-table-column label="Montaj T." width="140" sortable>
                  <template #default="scope">
                    <div style="display: flex; align-items: center">
                      <span>{{ scope.row.montajTarihi }}</span>
                    </div>
                  </template>
                </el-table-column>
                <el-table-column label="Sözleşme Kodu" width="160">
                  <template #default="scope">
                    <div style="display: flex; align-items: center">
                      <span>{{ scope.row.sozlesmeKodu }}</span>
                    </div>
                  </template>
                </el-table-column>
                <el-table-column label="Başlangıç T." width="140" sortable>
                  <template #default="scope">
                    <div style="display: flex; align-items: center">
                      <span>{{ scope.row.baslangicTarihi }}</span>
                    </div>
                  </template>
                </el-table-column>
                <el-table-column label="Bitiş T." width="140" sortable>
                  <template #default="scope">
                    <div style="display: flex; align-items: center">
                      <span>{{ scope.row.bitisTarihi }}</span>
                    </div>
                  </template>
                </el-table-column>
              </el-table>
...
export default defineComponent({
  ...
  setup() {
    ...
    var filter = ref<IMusteriRaporRaporFilter>({
      customerId: null,
      ilceId: null,
      sehirId: null,
      semtId: null,
