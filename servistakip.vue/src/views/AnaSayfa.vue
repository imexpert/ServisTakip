                ...
                <div class="d-flex flex-column mb-1 fv-row">
                  ...
                  <el-form-item prop="phone">
                    <el-input
                      ...
                      :formatter="
                        value =>
                          value.replace(/\D/g, '').replace(/^(\d{3})(\d{3})(\d{2})(\d{2}).*/, '+90-($1)-$2-$3-$4')
                      "
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-lg-12 col-xl-3 col-xxl-3 col-sm-12">
                ...
                <div class="d-flex flex-column mb-1 fv-row">
                  ...
                  <el-form-item prop="detectionCode">
                    ...
                    >
                      <el-option
                        v-for="item in detectionCodeList"
                        :key="item.code"
                        :label="item.name"
                        :value="item.code"
                      >
              ...
              <div class="col-md-12 col-lg-3 col-xl-3 col-xxl-3 col-sm-12">
                ...
                <div class="d-flex flex-column mb-1 fv-row">
                  ...
                  <el-form-item prop="name">
                    <el-input
                      v-model="newBakimService.blueCount"
                      class="customBorder"
                      placeholder="Mavi adet"
                    ></el-input>
                  </el-form-item>
                </div>
                <!--end::Input group-->
        ...
        >
          <div class="row">
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 mt-5">
              <button
                :data-kt-indicator="loading ? 'on' : null"
                class="btn btn-lg btn-primary btn-sm mt-5"
                type="submit"
              >
