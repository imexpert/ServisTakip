using ServisTakip.Core.CrossCuttingConcerns.Logging;
using ServisTakip.Core.CrossCuttingConcerns.Logging.Serilog;
...
namespace ServisTakip.Core.Aspects.Autofac.Exception
{
    /// <summary>
    /// ExceptionLogAspect
    /// </summary>
